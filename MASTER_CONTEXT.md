...
4. НЕ разбивать backend/index.js на модули. Один файл (~11 400 строк).
...
- Строк: ~11 351
- Эндпоинтов: 231 (GET: 89, POST: 97, PATCH: 23, DELETE: 22)
...
- ✅ Склад: склады, оборудование, расходники, движения
